...
[![Status](https://img.shields.io/badge/Status-Phase%205%20In%20Progress-red.svg)](https://github.com/nemorixgroup/xrpl-flutter-sdk/blob/main)  
...
> Phase 5 (DEX & Cross-Currency) in progress. See
...
| 4 | Core transactions (Payment, TrustSet, sign, submit) | `0.4.0-dev` | ✅ Done |
| 5 | DEX & cross-currency (OfferCreate, AMM, path finding) | `0.5.0-dev` | 🔄 In progress |
...
```dart
// Build a transaction, then let autofill handle Sequence, Fee, and
// LastLedgerSequence automatically.
